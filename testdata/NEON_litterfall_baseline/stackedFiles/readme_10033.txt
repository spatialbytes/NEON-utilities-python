...
Sensor(s): 
Keywords: net primary productivity (NPP), biomass, turnover, carbon cycle, detritus, leaves, nitrogen cycle, fine woody debris, d13C, senescence, biodiversity, vegetation, litterfall, d15N, production, gross primary productivity (GPP), ltr, plant productivity, litter
Domain: D11
DATA PACKAGE CONTENTS
---------------------
This folder contains the following documentation files:
This data product contains up to 9 data tables:
- Term descriptions, data types, and units: NEON.D11.CLBJ.DP1.10033.001.variables.20240104T224934Z.csv
